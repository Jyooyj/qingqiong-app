import 'campus_college_data.dart';
  ...
  static final List<CampusGeoZone> zones = List.unmodifiable([
    ...const <CampusGeoZone>[
      CampusGeoZone(
        id: 'lab_building',
        name: '实验楼',
        aliases: ['实验楼', '实验楼A', '公共实验楼A', '公共实验楼', '公共实验楼B'],
      ...
      // POIs from final-data-campus @ 0cca7d27; no cleaning routes supplied.
      CampusGeoZone(
        id: 'canteen_2',
        name: '第二餐厅',
